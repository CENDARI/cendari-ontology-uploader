...
<%@ page import="java.io.*, javax.servlet.*, javax.servlet.http.*, org.cendari.ontology.download.*, org.cendari.ontology.utility.Utility, java.util.*, org.json.simple.JSONArray, org.json.simple.JSONObject" %>
<html lang="en">
<head>
...
<body>
	...
	<div class="container">
		...
		<ul class="breadcrumb" style="background-color:white">
		  <li class="active">All Dataspaces</li>
		</ul>
		<hr>
	...
	<div id="myTabContent" class="tab-content">
		<div class="tab-pane fade active in" id="listdatasets">
			<table class="table table-striped table-hover ">
			  	<thead>
			    	<tr>
			      		<th class="col-md-1"></th>
			      		<th class="col-md-3">&nbsp;&nbsp;Dataspace Title</th>
			  	...
			  	<tbody>
			  		<%	
			        	...
			        	if (session.getAttribute("sessionKey") != null) {
			        		dataspaceArray = Utility.getDataspacesMetadata(request, session.getAttribute("sessionKey").toString(), "http://localhost:42042/v1/dataspaces");
			        	}
					...
					<tr>
			      		<td><%=count+1%></td>
			      		<td>
							<form action="ListDatasets.do" method="GET">
								<input type="hidden" name="dataspaceId" value="<%= dataspace.get("id")%>">
								<input type="hidden" name="dataspaceUrl" value="<%=dataspace.get("url") %>">
								<input type="hidden" name="dataspaceTitle" value="<%=dataspace.get("title") %>">
								<button type="submit" class="btn-link"><%=dataspace.get("title") %></button>
							</form>
						</td>
			      		<td><%=dataspace.get("description") %></td>
			      		<td><%=dataspace.get("visibility") %></td>
			      	</tr>
					<%	 
							}
						}
