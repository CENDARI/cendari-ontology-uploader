...
<body>
	...
	<div class="container">
		...
		<ul class="nav nav-wizard"">
			...
			<li class="active"><a>Additional Files</a></li>
		...
		<div id="myTabContent" class="tab-content">
			...
			<div class="tab-pane fade" id="originalfiles">
				...
				<form action="OriginalFilesUpload" method="POST">
					<br>
					<br>
					<br>
					<button type="submit" class="btn btn-primary">Next</button>
			...
			<div class="tab-pane fade" id="transformedfiles">
				<br>
				<form class="fileupload" action="//jquery-file-upload.appspot.com/" method="POST" enctype="multipart/form-data">
					<!-- Redirect browsers with JavaScript disabled to the origin page -->
					<noscript><input type="hidden" name="redirect" value="https://blueimp.github.io/jQuery-File-Upload/"></noscript>
			...
			<div class="tab-pane fade  active in" id="additionalfiles">
				<br>
				<form class="fileupload" action="RecvAdditionalFiles.do" method="POST" enctype="multipart/form-data">
					<!-- Redirect browsers with JavaScript disabled to the origin page -->
					<noscript><input type="hidden" name="redirect" value="https://blueimp.github.io/jQuery-File-Upload/"></noscript>
					<!-- The fileupload-buttonbar contains buttons to add/delete files and start/cancel the upload -->
					<div class="row fileupload-buttonbar">
						<div class="col-lg-7">
							<!-- The fileinput-button span is used to style the file input field as button -->
							<p class="lead">Please select additional file(s)</p>
							<span class="btn btn-success fileinput-button">
								<i class="glyphicon glyphicon-plus"></i>
								<span>Add files...</span>
								<input type="file" name="files[]" multiple>
				...
				<form action="RecvAllFiles.do" method="POST">
					...
					<div class="col-sm-12">
						...
						<button type="submit" class="btn btn-info pull-right">Generate Relationship File >></button>
					</div>
					<br>
					<br>
					<br>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<ul>
					<li>Please upload additional file(s) from this page if there is any.</li>
					<li>To upload additional file(s), please select file(s) from your computer and then press "Upload" button.</li>
					<li>You can press the "Cancel" button to cancel the uploading while a file is being uploaded.</li>
	            	<li>After uploading the additional file(s), please press "Generate Relationship File >>" button to generate the relationship file. The relationship file will be generated and then uploaded to CKAN server.</li>
	                <!-- 
