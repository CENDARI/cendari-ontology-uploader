...
<body>
	...
	<div class="container">
		...
		<ul class="nav nav-wizard"">
			...
			<li class="active"><a>Original Files</a></li>
		...
		<div id="myTabContent" class="tab-content">
			...
			<div class="tab-pane fade" id="uploadoriginalfiles">
				<br>
				<br>
			...
			<div class="tab-pane fade active in" id="originalfiles">
				...
				<form id= "fileupload" class="fileupload" action="RecvOriginalFiles.do" method="POST" enctype="multipart/form-data">
					...
					<div class="row fileupload-buttonbar">
						<div class="col-lg-7">
							<p class="lead">Please select original file(s)</p>
				...
				<form action="NextStep" method="GET">
					...
					<br>
					<div class="col-sm-12">
						<input type="hidden" name="nextPage" value="uploadtransformedfiles">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<ul>
					<li>To upload original file(s), please select file(s) from your computer and then press "Upload" button.</li>
					<li>You can press the "Cancel" button to cancel the uploading while a file is being uploaded.</li>
	            	<li>After uploading the original file(s), please press "Next Step >>" button to upload transformed file(s).</li>
	            	<!-- 
